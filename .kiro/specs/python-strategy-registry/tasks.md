...
- [x] 1. Create file structure and core interfaces
...
- [x] 2. Implement StrategyRegistry
...
- [x] 3. Implement BollingerBreakout strategy
  ...
  - [x] 3.1 Write property test for compute_signal output shape (Property 4)
...
- [x] 4. Extract and refactor ConfidenceEngine
  ...
  - [x] 4.1 Write property test for ConfidenceEngine output bounds (Property 7)
...
- [x] 5. Add new FastAPI endpoints and bootstrap registry in main.py
  ...
  - [x] 5.1 Write property test for low confidence suppresses signal (Property 8)
  ...
  - [x] 5.2 Write property test for analyze response shape (Property 9)
...
- [x] 7. Update Node.js BotManager to use new endpoint
  ...
  - [x] 7.1 Write property test for BotManager payload slicing (Property 10)
